...
2. Create `Codex-Menu-Bar.zip` from `.app` bundle
3. Generate `Codex-Menu-Bar.zip.sha256` checksum
4. Create draft GitHub Release with assets attached

**Outputs:**
- `Codex-Menu-Bar.zip` — App bundle for distribution
- `Codex-Menu-Bar.zip.sha256` — SHA256 checksum for verification
