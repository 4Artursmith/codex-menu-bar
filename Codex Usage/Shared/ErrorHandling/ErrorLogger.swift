//
//  ErrorLogger.swift
//  Codex Usage - Error Logging and Tracking
//
...
class ErrorLogger {
    ...
    private let logQueue = DispatchQueue(label: "com.codex-usage.errorlogger", qos: .utility)
    ...
    func exportLog() -> String {
        return logQueue.sync {
            var export = "=== Codex Menu Bar Error Log ===\n"
