...
enum Constants {
    ...
    static let appGroupIdentifier = "group.com.codexusagetracker.shared"
    ...
    enum CodexPaths {
        ...
        static var projectsDirectory: URL {
            codexDirectory.appendingPathComponent("projects")
        }
    }
    ...
    // API Endpoints
    enum APIEndpoints {
        static let codexBase = "https://codex.ai/api"
        static let consoleBase = "https://console.openai.com/api"
    }
