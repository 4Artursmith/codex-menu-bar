...
enum SessionKeyValidationError: LocalizedError {
    ...
    var recoverySuggestion: String? {
        ...
        case .invalidPrefix:
            return "Ensure you're copying the sessionKey cookie value, which should start with 'sk-codex-'"
...
struct SessionKeyValidator {
    ...
    private func validateFormat(_ sessionKey: String) throws {
        ...
        // This is typical of session key formats like: sk-codex-sid01-xxxxx-yyyyy
