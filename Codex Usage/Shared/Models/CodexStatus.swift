...
/// Model representing Codex system status
struct CodexStatus: Codable, Equatable {
    ...
    static var unknown: CodexStatus {
        CodexStatus(indicator: .unknown, description: "Status Unknown")
    }

    /// Operational status
    static var operational: CodexStatus {
        CodexStatus(indicator: .none, description: "All Systems Operational")
    }
}
