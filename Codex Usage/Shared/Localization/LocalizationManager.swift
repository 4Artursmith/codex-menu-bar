...
//  Codex Usage - Centralized Localization System
//
...
enum LocalizationKey: String {
    ...
    case codexCLI = "settings.codex_cli"
    case codexCLIDesc = "settings.codex_cli.description"
    case about = "settings.about"
    case aboutDesc = "settings.about.description"

    // MARK: - Menu Bar
    case codexUsage = "menubar.codex_usage"
    ...
    case openCodexAI = "setup.open_codex_ai"
