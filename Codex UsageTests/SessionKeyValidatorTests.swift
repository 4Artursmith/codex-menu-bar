...
final class SessionKeyValidatorTests: XCTestCase {
    ...
    func testValidSessionKey() {
        let validKey = "sk-codex-sid01-abcdefghijklmnopqrstuvwxyz1234567890"
    ...
    func testValidSessionKeyWithUnderscores() {
        let validKey = "sk-codex-sid01_abcdefghijklmnopqrstuvwxyz_1234567890"

        XCTAssertNoThrow(try validator.validate(validKey))
    }

    func testValidSessionKeyWithHyphens() {
        let validKey = "sk-codex-sid01-abcd-efgh-ijkl-mnop-qrst"
    ...
    func testSessionKeyWithLeadingTrailingWhitespace() throws {
        let keyWithWhitespace = "  sk-codex-sid01-abcdefghijklmnopqrstuvwxyz  "
    ...
    func testTooLong() {
        let longKey = "sk-codex-" + String(repeating: "a", count: 1000)
    ...
    func testInvalidCharacters() {
        let invalidKey = "sk-codex-sid01-hello@world!#$%"
    ...
    func testInternalWhitespace() {
        let invalidKey = "sk-codex-sid01 abcd efgh"
    ...
    func testNullBytes() {
        let invalidKey = "sk-codex-sid01-abc\0def"
    ...
    func testPathTraversal() {
        let invalidKey = "sk-codex-sid01-../etc/passwd"
    ...
    func testScriptInjection() {
        let invalidKey = "sk-codex-sid01-<script>alert('xss')</script>"
    ...
    func testValidFormat() {
        let validKey = "sk-codex-sid01-abc-def-ghi-jkl"

        XCTAssertNoThrow(try validator.validate(validKey))
    }

    func testInvalidFormatNoSeparators() {
        let invalidKey = "sk-codex-abcdefghijklmnopqrstuvwxyz"
    ...
    func testRelaxedConfiguration() {
        ...
        let shortKey = "sk-codex-s-hort"  // Must have separator after prefix
    ...
    func testSanitization() {
        let keyWithNewlines = "sk-codex-sid01-abcdefg\r\nhijklmn"
    ...
    func testValidationStatusValid() {
        let validKey = "sk-codex-sid01-abcdefghijklmnopqrstuvwxyz"
    ...
    func testUnicodeCharacters() {
        let unicodeKey = "sk-codex-sid01-héllo-wörld"
    ...
    func testErrorMessages() {
        let testCases: [(key: String, expectedErrorType: SessionKeyValidationError.Type)] = [
            ...
            ("sk-codex-", SessionKeyValidationError.self),
    ...
    func testSanitizationPerformance() {
        let keyWithIssues = "  sk-codex-sid01-abcdefghijklmnopqrstuvwxyz\r\n  "
    ...
    func testTypicalUserInput() {
        ...
        let copiedKey = """
        sk-codex-sid01-abcdefghijklmnopqrstuvwxyz1234567890-ABCDEFG
        """
    ...
    func testTypicalMistakes() {
        let mistakes = [
            ...
            "sessionKey=sk-codex-sid01-abcd"  // Copied the whole cookie line
        ]
