...
final class URLBuilderTests: XCTestCase {
    ...
    func testConsoleAPIBuilder() throws {
        ...
        XCTAssertEqual(url.absoluteString, "https://console.openai.com/api/organizations")
    }

    func testCodexStatusBuilder() throws {
        let url = try URLBuilder.codexStatus(endpoint: "/status.json").build()
        XCTAssertEqual(url.absoluteString, "https://status.openai.com/api/v2/status.json")
    }
