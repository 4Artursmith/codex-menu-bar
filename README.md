...
<div align="center">
  <img src=".github/cover.jpg" alt="Codex Menu Bar" width="100%">
  ...
  **A native macOS menu bar application for real-time monitoring of Codex AI usage limits**
  ...
  ### [Download Latest Release](https://github.com/4ArturSmith/codex-menu-bar/releases/latest)
...
Codex Menu Bar is fully open source under the MIT license.

- Source code: [4ArturSmith/codex-menu-bar](https://github.com/4ArturSmith/codex-menu-bar)
- License: [MIT](LICENSE)
...
Codex Menu Bar is a lightweight, native macOS menu bar application that provides real-time monitoring of your Codex AI usage limits. Built entirely with Swift and SwiftUI, it offers a clean, intuitive interface to track your 5-hour session window, weekly usage limits, and Opus-specific consumption.
...
Before installing Codex Menu Bar, ensure you have:
...
```bash
brew install --cask 4artursmith/codex-menu-bar/codex-menu-bar
```

Or tap first, then install:

```bash
brew tap 4artursmith/codex-menu-bar
...
**[Download Codex-Menu-Bar.zip](https://github.com/4ArturSmith/codex-menu-bar/releases/latest/download/Codex-Menu-Bar.zip)**

1. Download the `.zip` file from the link above
2. Extract the zip file (double-click or use Archive Utility)
3. Drag `Codex Menu Bar.app` to your Applications folder
...
3. **Navigate to Cookies**
   ...
   - Copy: The value (starts with `sk-codex-sid01-...`)
...
1. **Check Menu Bar**: You should see the Codex Menu Bar icon in your menu bar
...
- **Customize Interface**: Go to Settings → Appearance to choose your preferred menu bar style
...
echo "sk-codex-sid01-YOUR_SESSION_KEY_HERE" > ~/.codex-session-key
...
**New in v2.2.0**: Codex Menu Bar now supports unlimited profiles, allowing you to manage multiple Codex accounts seamlessly with automatic credential switching.
...
- **Live Status Indicator**: Real-time Codex system status from status.openai.com
...
[Codex Code](https://codex.com/codex-code) is OpenAI's official CLI tool for interacting with Codex AI directly from your terminal. The statusline feature allows you to display custom information at the bottom of your terminal window.
...
1. **Open Codex Menu Bar Settings**
   - Click the menu bar icon
   - Click "Settings"
...
1. Open Codex Menu Bar Settings → Codex Code tab
...
```
GET https://api.openai.com/v1/organization/{org_id}/usage
```
...
- **Network**: HTTPS-only communication with codex.ai and OpenAI API
...
<img src="https://contrib.rocks/image?repo=4ArturSmith/codex-menu-bar" alt="Contributors" height="30px" />
...
This application is not affiliated with, endorsed by, or sponsored by OpenAI PBC. Codex is a trademark of OpenAI PBC. This is an independent third-party tool created for personal usage monitoring.
